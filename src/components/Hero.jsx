...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative pt-16 pb-12 sm:pb-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 pb-16 sm:pb-20 relative z-10">
        <div className="text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 animate-slide-up px-4 mb-4 sm:mb-6" style={{ animationDelay: '0.8s' }}>
      ...
      <div className="absolute bottom-2 sm:bottom-6 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2 pointer-events-none z-20">
